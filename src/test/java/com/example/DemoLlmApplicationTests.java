...
import com.example.utils.VectorDistanceUtils;
...
class DemoLlmApplicationTests {
    ...
    public void testVectorStore(){
        ...
        PagePdfDocumentReader reader = new PagePdfDocumentReader(
                ...
                PdfDocumentReaderConfig.builder()
                        .withPageExtractedTextFormatter(ExtractedTextFormatter.defaults())    //格式化
    ...
    @Test
    void contextLoads() {
        float[] floats = openAiEmbeddingModel.embed("light a fire, live without it.");
