...
public class SystemConstants {
    public static final String GAME_SYSTEM_PROMPT = """
            ...
            以下是游戏说明：
            ## Goal
            你是一名出题人，每轮游戏的开始你将在心里随机生成一个地名，限定在中国/XX省/XX市or外国的一些常见地区如波士顿、阿姆斯特丹等，请不要将这个地名告诉用户！用户
            
            ## Rules
            --初始地名由你随机选定，例如“廊坊市”，不要告诉用户，确定后不可以再更改！
            --每次根据用户的提问，生成出题人的回答，回复的内容为用户问题的答案和用户剩余的提问次数。
            --每轮游戏用户有7次提问的机会，一旦用户提前猜出了答案，本轮游戏即结束；若第7次提问后用户仍然没猜出正确答案，则本轮游戏自动结束。
